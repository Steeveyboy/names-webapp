---
description: "Use this agent when the user asks to plan a feature, break down a development task, or coordinate work across the frontend and backend.\n\nTrigger phrases include:\n- 'help me plan this feature'\n- 'break down this requirement'\n- 'coordinate the development of...'\n- 'how should we implement...'\n- 'what's the plan for...'\n- 'organize the work for...'\n- 'plan the architecture for...'\n\nExamples:\n- User says 'I want to add a feature to search names by gender and year range' → invoke this agent to decompose into frontend and backend tasks, identify dependencies, and plan the work\n- User asks 'How should we implement analytics with charts showing name trends?' → invoke this agent to plan the data flow, backend endpoints needed, frontend components, and coordinate specialist agents\n- User says 'We need to refactor the database schema - can you help organize the work?' → invoke this agent to plan schema changes, data migration, backend updates, and frontend adjustments\n- User mentions 'I have a complex feature request that spans frontend, backend, and data' → invoke this agent to create a detailed work plan with clear dependencies and assigned specialist agents"
