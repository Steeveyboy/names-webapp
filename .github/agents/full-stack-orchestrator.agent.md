---
description: "Use this agent when the user asks to plan a feature, break down a development task, or coordinate work across the frontend and backend.\n\nTrigger phrases: 'help me plan this feature', 'break down this requirement', 'coordinate the development of', 'how should we implement', 'what's the plan for', 'organize the work for', 'plan the architecture for'.\n\nExamples:\n- 'I want to add a feature to search names by gender and year range' → decompose into frontend and backend tasks, identify dependencies, and plan the work\n- 'How should we implement analytics with charts showing name trends?' → plan the data flow, backend endpoints, frontend components, and coordinate specialist agents\n- 'We need to refactor the database schema' → plan schema changes, data migration, backend updates, and frontend adjustments\n- 'I have a complex feature request spanning frontend, backend, and data' → create a detailed work plan with dependencies and assigned specialist agents"
